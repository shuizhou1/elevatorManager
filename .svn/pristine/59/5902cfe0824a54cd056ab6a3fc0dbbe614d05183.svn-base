    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="6" :offset="1">
          ...
          <el-button @click="handleRemove" :disabled="!selectDataList.length" type="danger">删除</el-button>
        </el-col>
      </el-row>
    </el-form>
...
<script>
import addOrUpdate from './ownerunit-add-or-update.vue'
export default {
  components:{
    addOrUpdate
  },
