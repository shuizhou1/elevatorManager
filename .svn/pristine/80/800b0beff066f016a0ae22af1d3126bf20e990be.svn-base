...
<template>
  ...
  >
    ...
    >
      ...
      <el-table-column align="center" prop="deviceName" width="100" label="设备名称"></el-table-column>
      <el-table-column align="center" prop="deviceArea" width="100" label="定点"></el-table-column>
      ...
      <el-table-column align="center" prop="deviceMethod" width="100" label="定法"></el-table-column>
      ...
      <el-table-column align="center" prop="cycle" label="周期"  width="80"></el-table-column>
       ...
       <el-radio-group
          ...
          <div class="button_wraper">
           <el-button type="primary" @click="updateStatus" style="margin-right:20px">确定</el-button>
            <el-button  @click="selectVisible=false;currentStatus='';" style="margin-right:20px">取消</el-button>
          </div>
    </div>
    </el-dialog>
  </el-dialog>
