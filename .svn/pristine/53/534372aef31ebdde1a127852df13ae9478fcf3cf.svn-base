<template>
    <el-dialog :modal="false" :show-close="false"  :close-on-click-modal="false" :visible.sync="visible"
               :fullscreen="true">
        <div slot="title" class="dialog_headslot">{{this.dataForm.id ? '人员信息' : '新增人员'}}
        ...
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
		   ...
		   <!-- <el-row>
			       ...
			       <el-form-item label="单位类型" prop="unitType">
			           <el-select v-model.trim="dataForm.unitType" clearable placeholder="请选择">
			...
			<el-row :gutter="30">
                ...
                <el-col :span="12">
                    <el-form-item label="状态" prop="status">
                        <el-select v-model.trim="dataForm.status" clearable placeholder="请选择">
...
<el-row :gutter="30">
            <el-col :span="12">
               <el-form-item label="性别" prop="sex">
                   <el-select v-model.trim="dataForm.sex" clearable placeholder="请选择">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            init (id,unitId) {
              console.log('userinit',id)
              console.log('userinit',unitId)
