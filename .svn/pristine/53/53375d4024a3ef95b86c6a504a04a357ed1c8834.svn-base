<template>
	<el-dialog title="日志列表" :close-on-click-modal="false" :fullscreen="true" :modal="false" :visible.sync="visible">
		<el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
			<el-form-item>
				<el-input v-model.trim="dataForm.id" placeholder="任务ID" clearable></el-input>
			</el-form-item>
			<el-form-item>
				<e-button ref="eproButton" v-on:handleClick="handleClick" :parentId="'6'" :busType="'querylist'"></e-button>
