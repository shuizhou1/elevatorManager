<template>
  <div class="mod-config">
    <el-form  class="form" :model="dataForm" @keyup.enter.native="getDataList('init')">       
    <el-row :gutter="30">
      <el-col :span="8">
       <el-form-item label prop="setime" class="none_margin_bottom">
          <el-date-picker
            clearable
            v-model.trim="dataForm.setime"
            type="daterange"
