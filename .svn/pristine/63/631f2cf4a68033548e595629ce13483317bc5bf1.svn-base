    ...
    <div class="form_wraper">
      ...
      >
        <el-row :gutter="30">
          ...
          <el-col :span="8">
            <el-form-item class="none_margin_bottom" label="状态" prop="maintenanceStutas">
              <el-select v-model.trim="formData.maintenanceStatus" clearable placeholder="请选择">
                <el-option
          ...
          >详情</el-button>
           <el-button
            ...
            v-if="isAuth('maintenance:maintenanceplan:yy')"
						:disabled="(scope.row.maintenanceStatus!='1'&&scope.row.maintenanceStatus!='2')||scope.row.juedge=='true'"
            style="padding:8px 10px;font-size:12px;height:36px"
            type="warning"
          ...
          >预约</el-button>
           <el-button
            ...
            v-if="isAuth('maintenance:maintenanceplan:delete')"
						:disabled="scope.row.maintenanceStatus!=2"
            style="padding:8px 10px;font-size:12px;height:36px"
            type="delete"
...
export default {
  ...
  methods: {
    ...
    handleOrder(row){
      ...
      this.loading = true;
      this.$http({
        url: this.$http.adornUrl('/maintenanceplan/maintenanceplan/infoAll'),
        method: "get",
        params: this.$http.adornParams({
          planId: row.planId
        })
