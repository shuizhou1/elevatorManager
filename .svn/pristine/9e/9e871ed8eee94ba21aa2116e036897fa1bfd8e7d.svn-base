<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">       
        <el-form-item class="none_margin_bottom" label="username" prop="username">
        <el-input v-model.trim="dataForm.username" placeholder="username"></el-input>
        </el-form-item>
      <el-form-item class="none_margin_bottom">
        ...
        <el-button v-if="isAuth('testModule:user:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">删除</el-button>
      </el-form-item>
    </el-form>
    <el-table @row-dblclick="dbclickRow" height="640"
      :data="dataList"
      border
