<template>
	<el-dialog :title="!dataForm.id ? '新增' : '修改'" :show-close="false" :close-on-click-modal="false" :visible.sync="visible" :fullscreen="true" :modal="false">
		...
		<el-form :model="dataForm"  :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="95px">
			<el-form-item label="角色名称" prop="roleName">
				<el-input v-model.trim="dataForm.roleName" type="text" placeholder="角色名称" maxlength="30" show-word-limit></el-input>
			</el-form-item>
		...
		<div class="button_wraper">
			  <!-- <e-button ref="eproButton1" v-on:handleClick="handleClick" :parentId="'3'" :busType="'edit'" ></e-button> -->
