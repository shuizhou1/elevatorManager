  ...
  <div class="form_wraper">
    ...
    >
      <el-row :gutter="30">
        ...
        <!--<el-col :span="8">-->
          <!--<el-form-item class="none_margin_bottom"   label="在线状态" prop="elevatorStatus">-->
            <!--<el-select v-model.trim="dataForm.elevatorStatus" placeholder="请选择">-->
              <!--<el-option-->
        ...
        <!--</el-col>-->
          <el-col :span="7">
              <el-form-item class="none_margin_bottom"  label="维保单位" prop="unitName">
                  <el-input v-model.trim="dataForm.unitName" clearable></el-input>
              </el-form-item>
          </el-col>
          <el-col :span="3">
    ...
    >
      ...
      <el-table-column prop="local" align="center" show-overflow-tooltip  label="地址"></el-table-column>
      <el-table-column prop="maintenanceName" show-overflow-tooltip  label="维保单位"></el-table-column>
      <el-table-column
        prop="elevatorStatus"
