  ...
  <el-dialog :modal="false"
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="95px">
      <el-form-item label="部门名称" prop="name">
        <el-input v-model.trim="dataForm.name" placeholder="部门名称"></el-input>
      </el-form-item>
      <el-form-item label="上级部门" prop="parentName">
        ...
        <el-input v-model.trim="dataForm.parentName" v-popover:menuListPopover :readonly="true" placeholder="点击选择上级部门" class="menu-list__input"></el-input>
      </el-form-item>
      <el-form-item label="部门代码" prop="code">
        <el-input v-model.trim="dataForm.code" placeholder="部门代码"></el-input>
      </el-form-item>
      <el-form-item label="部门地址" prop="dzbm">
        <el-input v-model.trim="dataForm.dzbm" placeholder="部门地址"></el-input>
      </el-form-item>
      <el-form-item label="部门资质" prop="bmzz">
        <el-input v-model.trim="dataForm.bmzz" placeholder="部门资质"></el-input>
      </el-form-item>
      <el-form-item label="部门类型" prop="dwlx">
        <el-input v-model.trim="dataForm.dwlx" placeholder="部门类型"></el-input>
      </el-form-item>
