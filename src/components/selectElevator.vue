...
<template>
  ...
  <el-form class="dialog_head_form" ref="form" :model="queryElevatorForm" @keyup.enter.native="getDataList()">
      <el-row :gutter="30">
        <!-- <el-col :span="7" v-if="isMaintenanceappointment">
          <el-form-item label="维保单位" prop="unitname">
            <el-input v-model.trim="queryElevatorForm.unitname" placeholder="维保单位" clearable></el-input>
          </el-form-item>
        </el-col> -->
        <el-col :span="8">
          <el-form-item label="电梯地址" prop="locals">
            <el-input v-model.trim="queryElevatorForm.locals" placeholder="电梯地址" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="注册代码" prop="regCodes">
            <el-input v-model.trim="queryElevatorForm.regCodes" placeholder="注册代码" clearable></el-input>
          </el-form-item>
        </el-col>
           <el-col :span="3">
          <el-form-item>
...
export default {
 ...
 computed:{
  ...
  methods: {
    ...
    init(unitId,regcodes) {
      console.log('init',unitId)
      console.log('init',regcodes)
      if(unitId){
        this.queryElevatorForm.maintenanceId = unitId;
      }
    ...
    selectBack(){
      ...
      this.$nextTick(()=>{
        if(this.regcodes&&this.regcodes.length){
    ...
    getDataList(type) {
      ...
      this.$http({
        ...
        params: this.$http.adornParams({
          ...
          maintenanceId:this.queryElevatorForm.maintenanceId,
