                ...
                <el-row :gutter="30">
                    <el-col :span="24">
                        <el-form-item prop="oldPwd" label="旧密码" label-width="">
                            <el-input placeholder="请输入旧密码" clearable v-model.trim="formData.oldPwd" type="password" :show-password="true" ></el-input>
                        </el-form-item>
                    </el-col>
                     <el-col :span="24">
                        <el-form-item prop="newPwd" label="新密码">
                            <el-input placeholder="请输入新密码" clearable v-model.trim="formData.newPwd" type="password" show-password></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item prop="confirmNewPwd" label="确认新密码">
                            <el-input placeholder="请输入新密码" clearable v-model.trim="formData.confirmNewPwd" type="password" show-password></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
           </el-form>
