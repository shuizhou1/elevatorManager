      ...
      <el-row :gutter="30">
        ...
        <el-col :span="12">
          <el-form-item label="用户名" prop="userName">
            <el-input v-model.trim="dataForm.userName" :disabled="dataForm.id"  maxlength="30" placeholder="登录名" clearable></el-input>
          </el-form-item>

        </el-col>
        <el-col :span="12">
          <el-form-item label="性别" prop="sex">
            <el-select v-model.trim="dataForm.sex" :disabled="dataForm.id" clearable placeholder="请选择">
              <el-option
      ...
      <el-row :gutter="30">
        ...
        <el-col :span="12">
          <el-form-item label="单位名称" prop="unitName">
            <el-input v-model.trim="dataForm.unitName" clearable placeholder="单位名称">
