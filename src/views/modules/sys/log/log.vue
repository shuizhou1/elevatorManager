<template>
  <div class="mod-log">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model.trim="dataForm.key" placeholder="用户名／用户操作" clearable></el-input>
      </el-form-item>
      <el-form-item>
      	 <e-button ref="eproButton" v-on:handleClick="handleClick" :parentId="'29'" :busType="'query'" ></e-button>
