<template>
	<div class="mod-menu">
		<el-form :inline="true" :model="dataForm">
			<el-form-item>
				<e-button ref="eproButton" v-on:handleClick="handleClick" :parentId="'4'" :busType="'query'"></e-button>
				<!--				<el-button v-if="isAuth('sys:user:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
--></el-form-item>
		</el-form>
		<el-table :data="dataList" border style="width: 100%;"  @header-dragend="handleDragend">
			...
			<el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
				<template slot-scope="scope">
					<e-button ref="eproButton1" v-on:handleClick="handleClick" :parentId="'4'" :busType="'update'" :params="''+scope.row.menuId"></e-button>
...
<script>
	...
	import AddOrUpdate from '../menu/menu-add-or-update'
