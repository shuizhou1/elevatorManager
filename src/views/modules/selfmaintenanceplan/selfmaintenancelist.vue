...
<template>
  <div>    
    ...
    >
      <el-row :gutter="30">
        <el-col :span="8">
          <el-form-item class="none_margin_bottom" label="检查人员" >
            <el-input v-model.trim="formData.createUserName" clearable ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="none_margin_bottom" label="注册代码">
            <el-input v-model.trim="formData.regCode" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
    ...
    getDataList(type) {
      ...
      this.$http({
        ...
        params:this.$http.adornParams({
          ...
          regCode:this.formData.regCode,//注册码
        })
      })
        .then(({data}) => {
          if(data&&data.code==0){
