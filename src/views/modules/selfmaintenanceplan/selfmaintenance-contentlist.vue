        ...
        <el-row :gutter="30">
          <el-col :span="12">
            <el-form-item label="本月自主维护内容编制人员" prop="planUserName">
              <el-input v-model.trim="detailFormData.planUserName" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="本月自主维护内容审核人" prop="planTime" clearable>
              <el-input v-model.trim="detailFormData.checkUserName" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>-->
