...
<template>
  <div>    
    <div class="header">自主维护待确认列表</div>
    <el-form
      ref="form"
      :model="formData"
      class="form"
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="检查人员" >
            <el-input v-model.trim="formData.processUserName"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="确认人">
            <el-input v-model.trim="formData.checkDirectorUserName"></el-input>
          </el-form-item>
        </el-col>
    ...
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="processTime" label="检查时间" align="center" show-overflow-tooltip></el-table-column>
      <el-table-column prop="processUserName" label="检查员" align="center"></el-table-column>
      <el-table-column prop="local" label="设备地址" align="center"></el-table-column>
      <el-table-column prop="checkDirectorTime" label="最后确认时间" align="center"></el-table-column>
      <el-table-column prop="elevatorStatus" :formatter="formatStatus" label="状态" align="center"></el-table-column>
      <el-table-column prop="checkFailRemark" label="不同过原因" align="center"></el-table-column>
...
export default {
  ...
  data() {
    return {
     ...
     formData: {
        processUserName:'',//检查人员
        checkDirectorUserName:''//确认人
      },
      tableData: [
      ],
      selectDataList:[],
