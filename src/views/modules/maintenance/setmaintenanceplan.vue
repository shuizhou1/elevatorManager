          ...
          <el-row :gutter="30">
            ...
            <el-col :span="8" >
              <el-form-item label="维保单位" prop="maintenanceUnit">
                <el-input v-model.trim="formData.maintenanceUnit" disabled>
             ...
             <el-col :span="8">
              <el-form-item label="维保电梯" prop="regCode">
                <el-input v-model.trim="formData.regCode" disabled>
                  <template slot="append">
             ...
             <el-col :span="8" >
              <el-form-item label="维保期数" prop="maintenanceCount">
                <el-input v-model.trim="formData.maintenanceCount" min="1" type="number" v-enterNumber></el-input>
              </el-form-item>
            </el-col>
            
            <!-- <el-col :span="7" :offset="1">
              <el-form-item label="维护期限" prop="maintenanceDate">
                <el-input v-model.trim="formData.maintenanceDate"></el-input>
              </el-form-item>
            </el-col>-->
          </el-row>
          <el-row :gutter="30">
            <el-col :span="8">
              <el-form-item label="每期间隔" type="number" min="1" prop="maintenanceSize" v-enterNumber>
                <el-input v-model.trim="formData.maintenanceSize">
                  <template slot="append">天</template>
						 ...
						 <el-col :span="8">
						  <el-form-item label="开始时间" prop="maintenanceStartTime">
						    <el-date-picker
						      v-model.trim="formData.maintenanceStartTime"
              ...
              <el-col :span="8">
                  <el-form-item label="联系人" prop="processUser">
                    ...
                    <el-input v-model.trim="formData.processUser"></el-input>
                  </el-form-item>
                </el-col>
            <!-- <el-col :span="1">
