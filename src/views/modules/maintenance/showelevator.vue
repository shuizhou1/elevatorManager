...
<template>
  ...
  >
  <div  slot="title" class="dialog_headslot">维保电梯
      <el-button @click="visible=false">返回</el-button>

  </div>
  <el-form :model="queryElevatorForm" class="dialog_head_form" @keyup.enter.native="getDataList()">
      <el-row :gutter="30">
        <el-col :span="7">
 ...
 computed:{
  ...
  methods: {
    ...
    getDataList(type) {
      ...
      let url = '/elevatorinformation/elevatorinformation/maintenanceElv'
      this.$http({
