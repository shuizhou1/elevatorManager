<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">       
        ...
        <el-input v-model.trim="dataForm.cid" placeholder="主键"></el-input>
        </el-form-item>
        <el-form-item label="父类型ID" prop="parentid">
        <el-input v-model.trim="dataForm.parentid" placeholder="父类型ID"></el-input>
        </el-form-item>
        <el-form-item label="排序" prop="seqno">
        <el-input v-model.trim="dataForm.seqno" placeholder="排序"></el-input>
        </el-form-item>
