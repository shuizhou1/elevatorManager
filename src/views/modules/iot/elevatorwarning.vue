        ...
        <el-row :gutter="30">
          ...
          <el-col :span="8">
            <el-form-item class="none_margin_bottom" label="报警类型" prop="type" >
              <el-select v-model.trim="dataForm.type" placeholder="请选择" clearable>
                <el-option
        ...
        <el-row :gutter="30">
          ...
          <el-col :span="8">
            <el-form-item class="none_margin_bottom" label="事件类型" prop="code" >
              <el-select v-model.trim="dataForm.code" placeholder="请选择" clearable>
                <el-option
    ...
    >
      ...
      <el-table-column   header-align="center" align="center" label="发生时间">
        <template slot-scope="scope">
          {{scope.row.solveTime||scope.row.colDateTime}}
        </template>
      </el-table-column>
      <el-table-column
        prop="type"
      ...
      <el-table-column label="操作"  align="center" width="160px">
        <template slot-scope="scope">
          ...
          <el-button
            size="mini"
            type="primary"
            style="padding:8px 10px;font-size:12px;height:36px;margin-left:0"
