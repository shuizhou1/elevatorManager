  ...
  <div>    
    ...
    >
      <el-row :gutter="30">
        ...
        <el-col :span="8">
          <el-form-item class="none_margin_bottom" label="联系人">
            <el-input v-model.trim="formData.contactName" clearable></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6" :offset="1">
          <el-button @click="getDataList('init')" type="query">查询</el-button>
          <el-button @click="handleAddorUpdate()" type="add">新增</el-button>
          <el-button @click="handleRemove" :disabled="!selectDataList.length" type="delete">删除</el-button>
        </el-col>
      </el-row>
    </el-form>
...
<script>
import addOrUpdate from './maintenanceunit-add-or-update';
export default {
  components:{
    addOrUpdate
  },
  ...
  methods: {
    ...
    handleRemove() {
      ...
      this.$confirm(`确定删除?`, "提示", {
        ...
        this.$http({
          url: this.$http.adornUrl("/maintenanceunit/maintenanceunit/delete"),
          method: "post",
